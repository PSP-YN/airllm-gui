...
class AutoModel:
    ...
    @classmethod
    def get_module_class(cls, pretrained_model_name_or_path: str, *inputs: Any, **kwargs: Any) -> Tuple[str, str]:
    ...
    @classmethod
    def from_pretrained(cls, pretrained_model_name_or_path: str, *inputs: Any, **kwargs: Any) -> Any:
