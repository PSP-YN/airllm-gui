...
def load_layer(local_path: Union[str, Path], layer_name: str, profiling: bool = False) -> Union[Dict, Tuple[Dict, float]]:
...
def check_space(
    ...
    layer_shards_saving_path: Optional[Path] = None,
...
def split_and_save_layers(checkpoint_path, layer_shards_saving_path=None, splitted_model_dir_name='splitted_model',
                          compression=None, layer_names=None, delete_original=False, repo_id=None):
    """
...
def find_or_create_local_splitted_path(model_local_path_or_repo_id, layer_shards_saving_path=None, compression=None,
                                       layer_names=None, delete_original=False):
    """
    ...
    # delay download now...
    '''
    hf_cache_path = huggingface_hub.snapshot_download(model_local_path_or_repo_id, allow_patterns="model.safetensors.index.json")
